...
public static class ContextShortcuts
{
    ...
    [Obsolete("",true)] public static bool ml072OrNewer => true;
    ...
    { get {
            if(SR2EEntryPoint._mlVersion=="undefined")
            {
                ...
                catch
                {
                    ...
                    MelonLogger.Error("MelonLoader.BuildInfo.Version changed, if you are using not using the latest ML version, please update," + "otherwise this will be fixed in the next SR2E release!");
                    try
                    {
